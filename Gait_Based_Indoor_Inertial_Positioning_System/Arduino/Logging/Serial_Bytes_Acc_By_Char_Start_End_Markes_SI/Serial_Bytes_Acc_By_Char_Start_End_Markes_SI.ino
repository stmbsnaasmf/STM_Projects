...
#define VALUE_SEPARATOR 44  //44 appears to be comma
...
void setup()
{
  ...
  if (devStatus == 0) {
    ...
    while (millis() < 10000)
    {
      ...
      Serial.print(currentMilliseconds);  Serial.write(VALUE_SEPARATOR);
      Serial.print(ax, 6);  Serial.write(VALUE_SEPARATOR);
      Serial.print(ay, 6);  Serial.write(VALUE_SEPARATOR);
      Serial.print(az, 6);
...
void loop()
{
  ...
  //  Serial.write(NEWLINE);   //THE NEWLINE      //For all that testing that took place previously, this line was out of its intended
  //scope. Deletion of the ending curly bracket preceding this line led to the discovery of this bug. 7 Dec 2019 6:40 pm You Will Not
  //Be Missed For You Already Were A Marker For Binary Data
