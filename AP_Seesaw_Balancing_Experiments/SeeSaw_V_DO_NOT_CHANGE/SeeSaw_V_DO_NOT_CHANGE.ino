...
//float roll;
int32_t rollError;
int32_t desiredRoll = 000;
uint32_t proportionalConstant = 1000;  //Units in Hundreds          //8, 10,000, 2 work ok.
...
uint16_t integralConstant = 1000;    //From 100 to 1000 as a rough guide.

int16_t rollErrorRate;
uint16_t derivativeConstant = 10;
...
void loop()
{
  ...
  //m1.writeMicroseconds(constrain(m1Position, 1130, MAX_ALLOWED_POSITION));
  //  m2.writeMicroseconds(constrain(m2Position, 1130, MAX_ALLOWED_POSITION));
