...
#define USUAL_ESC_POSITION 1350

#define MAX_ALLOWED_POSITION 2000   //  (°-°): I am Areej.
...
uint16_t integralConstant = 1000;

int16_t rollErrorRate;
uint16_t derivativeConstant = 15;
